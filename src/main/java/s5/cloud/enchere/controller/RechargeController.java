...
public class RechargeController {
     ...
     public ResponseEntity<Object> recharge(@PathVariable int customerid, @RequestBody Account account,
     ...
     public ResponseEntity<Object> etatCompte(@PathVariable int customerid, @RequestHeader HttpHeaders headers,
     ...
     public ResponseEntity<Object> historique(@PathVariable int customerid, @RequestHeader HttpHeaders headers,
               HttpServletResponse httpResponse) {
          try {
